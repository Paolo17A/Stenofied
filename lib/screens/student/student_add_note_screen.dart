...
class StudentAddNoteScreen extends ConsumerStatefulWidget {
  const StudentAddNoteScreen({super.key});

  @override
  ConsumerState<StudentAddNoteScreen> createState() =>
      _StudentAddNoteScreenState();
}

class _StudentAddNoteScreenState extends ConsumerState<StudentAddNoteScreen> {
  ...
  Widget _saveButton() {
    return IconButton(
        onPressed: () {
          mayPop = true;
          NotesCollectionUtil.addNote(context, ref,
